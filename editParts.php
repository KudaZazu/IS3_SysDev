...
$query = "SELECT name, quantity from parts_stock where part_id={$_GET['id']}";
...
<div class= "text-center" id="ModalForm" tabindex="-1" aria-hidden="true" >
            ...
            <div class="modal-content">
                ...
                <form action="update.php" method="post">
                    <div class="modal-header">
                        <h5 class="text-center">How Many Parts Used?</h5>
        ...
        <input type="text"  name="partName" id="partName" placeholder="<?php  echo $name?>" ><br>
                        ...
                        <div class="mb-3">
                        <label for="id"><b>Ticket:<span class="text-danger">*</span></label>
        <input type="text"  name="id" id="id" value="<?php  echo $_SESSION['ticket']?>" ><br><br>
                        </div>
        ...
        <input type="number" id="quantity" min="0" size="2" name="quantity" placeholder="1" max="5" required >
                    ...
                    <div class="modal-footer pt-4">
                        <button type="submit" class="btn btn-success mx-auto w-100">Update</button>
                    </div>
                </form>
            </div>
        </div>
...
<!--    <div class="signup-popup" id="SignUp">
    <form action="update.php" class="form-container" method="post">
        ...
        <input type="text"  name="partName" id="partName" placeholder="<?php  echo $name?>" ><br>
<br>
        <label for="id"><b>Ticket:</b></label><br>
        <input type="text"  name="id" id="id" value="<?php  echo $_SESSION['ticket']?>" ><br><br>
