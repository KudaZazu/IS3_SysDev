...
<body>
            ...
            <input type="text" name="result" value="Ticket successfully created!" hidden>
                <div id="center">
                    <div class="mb-1 mt-1">
                        ...
                        <input type="text" id="Fnameid" name="Fname" class="form-control" required>
                    </div>
                    <div class="mb-1">
                        <label for="Lnameid" class="form-label">Last Name:</label>
                        <input type="text" id="Lnameid" name="Lname" class="form-control" required>
                    </div>
                    <div class="mb-1">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" id="numberid" name="number" class="form-control"  maxlength="10" size="10" pattern="[0]{1}[0-9]{9}" required>
                    </div>
                </div>
        </div>
        <div class="col"></div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <input type="Submit" name="submit" value="Submit Repair" class="w-100 btn btn-success">
        </div>
        <div class="col-sm-3"></div>
    </div>
